...
<html lang="en">
  <head>
    ...
    <title> Intrusion Detection System | Landing Page </title>
  ...
  <body>
    ...
    <div class="site-wrap">
      ...
      <header class="fbs__net-navbar navbar navbar-expand-lg dark" aria-label="freebootstrap.net navbar">
        <div class="container d-flex align-items-center justify-content-between">
          ...
          <a class="navbar-brand w-auto" href="index.html">
           ...
           <a href="#" class="app-brand-link" style="text-decoration: none; border: none; display: flex; align-items: center; gap: 8px;">
              <span class="app-brand-logo demo">
                <img src="{{ asset('images/logo.png') }}" alt="logo" width="60px" height="50px" style="margin-right: 0.35rem; vertical-align: middle;" />
              </span>
          ...
          <div class="offcanvas offcanvas-start w-75" id="fbs__net-navbars" tabindex="-1" aria-labelledby="fbs__net-navbarsLabel">
            ...
            <div class="offcanvas-body align-items-lg-center">
              ...
              <ul class="navbar-nav nav me-auto ps-lg-5 mb-2 mb-lg-0">
                ...
                <li class="nav-item d-lg-none"><a class="nav-link scroll-link" href="javascript:void(0)" onclick="scrollToLogin()">Login</a></li>
              </ul>
          ...
          <div class="ms-auto w-auto">
            ...
            <div class="header-social d-flex align-items-center gap-1"><a class="btn btn-primary py-2 d-none d-lg-block" href="javascript:void(0)" onclick="scrollToLogin()">Login</a>
      ...
      <main>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-6 mb-4 mb-lg-0">
                <div class="row">
                  <div class="col-lg-11"><span class="hero-subtitle text-uppercase" data-aos="fade-up" data-aos-delay="0">Intrusion Detection & Monitoring</span>
                    <h1 class="hero-title mb-3" data-aos="fade-up" data-aos-delay="100">Real-time Network Threat Detection</h1>
                    <p class="hero-description mb-4 mb-lg-5" data-aos="fade-up" data-aos-delay="200">Monitor network traffic, detect intrusions, and receive actionable alerts to help you investigate and respond quickly.</p>
                    <div class="cta d-flex gap-2 mb-4 mb-lg-5" data-aos="fade-up" data-aos-delay="300"><a class="btn" href="#">Open Dashboard</a><a class="btn btn-white-outline" href="#how-it-works">Learn More 
              ...
              <div class="col-lg-6">
                <div class="hero-img"><img class="img-main img-fluid rounded-4" src="{{ asset('images/pic1.jpg') }}" alt="Hero Image" data-aos="fade-in" data-aos-delay="500"></div>
              </div>
            </div>
          </div>
          <!-- End Hero-->
            ...
            <div class="row">
              <div class="col-md-6 order-md-2">
                <div class="row justify-content-end">
                    <div class="col-md-11 mb-4 mb-md-0"><span class="subtitle text-uppercase mb-3" data-aos="fade-up" data-aos-delay="0">About</span>
                    <h2 class="mb-4" data-aos="fade-up" data-aos-delay="100">Intrusion Detection & Monitoring System</h2>
                    <div data-aos="fade-up" data-aos-delay="200">
                      <p>We provide continuous monitoring of network traffic to identify malicious activity and suspicious behavior in real time.</p>
                      <p>Our dashboards surface attack trends, top targets, and detailed logs so security teams can triage and respond efficiently.</p>
                    </div>
              ...
              <div class="col-md-6"> 
                <div class="img-wrap position-relative"><img class="img-fluid rounded-4" src="{{ asset('images/pic2.jpg') }}" alt="FreeBootstrap.net image placeholder" data-aos="fade-up" data-aos-delay="0">
          ...
          <div class="container">
            <div class="row mb-5">
              <div class="col-md-6 text-center mx-auto"><span class="subtitle text-uppercase mb-3" data-aos="fade-up" data-aos-delay="0">How it works</span>
                <h2 data-aos="fade-up" data-aos-delay="100">Data Flow: From Network to Dashboard</h2>
                <p data-aos="fade-up" data-aos-delay="200">Traffic is captured at the network edge, processed by sniffers/collectors, ingested through the API where detection and enrichment occur, and then stored in the website database for visualization and alerting.</p>
              </div>
            </div>
            <div class="row g-md-5">
              <div class="col-md-6 col-lg-3">
                <div class="step-card text-center h-100 d-flex flex-column justify-content-start position-relative" data-aos="fade-up" data-aos-delay="0">
                  <div data-aos="fade-right" data-aos-delay="500"><img class="arch-line" src="assets/images/arch-line.svg" alt=""></div><span class="step-number rounded-circle text-center fw-bold mb-5 mx-auto">1</span>
                  <div>
                    <h3 class="fs-5 mb-4">Router / Probe</h3>
                    <p>Routers or network taps mirror traffic to probes; these devices forward raw packets to local sniffers for inspection.</p>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="600">
                <div class="step-card reverse text-center h-100 d-flex flex-column justify-content-start position-relative">
                  <div data-aos="fade-right" data-aos-delay="1100"><img class="arch-line reverse" src="assets/images/arch-line-reverse.svg" alt=""></div><span class="step-number rounded-circle text-center fw-bold mb-5 mx-auto">2</span>
                  <h3 class="fs-5 mb-4">Sniffer / Collector</h3>
                  <p>Collectors parse packets into structured events, enrich them (geo, DNS), and forward events to the ingestion API.</p>
                </div>
              </div>
              <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="1200">
                <div class="step-card text-center h-100 d-flex flex-column justify-content-start position-relative">
                  <div data-aos="fade-right" data-aos-delay="1700"><img class="arch-line" src="assets/images/arch-line.svg" alt=""></div><span class="step-number rounded-circle text-center fw-bold mb-5 mx-auto">3</span>
                  <h3 class="fs-5 mb-4">API Ingestion & Detection</h3>
                  <p>The API receives events, applies detection rules and risk classification, then acknowledges and persists alerts for further analysis.</p>
                </div>
              </div>
              <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="1800">
                <div class="step-card last text-center h-100 d-flex flex-column justify-content-start position-relative"><span class="step-number rounded-circle text-center fw-bold mb-5 mx-auto">4</span>
                  <div>
                    <h3 class="fs-5 mb-4">Database & Dashboard</h3>
                    <p>Events and alerts are stored in the website database; dashboards provide charts, top attacked IPs, and filters to investigate incidents.</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section class="section services__v3" id="services">
          <div class="container">
            <div class="row mb-5">
              <div class="col-md-8 mx-auto text-center"><span class="subtitle text-uppercase mb-3" data-aos="fade-up" data-aos-delay="0">Key Capabilities</span>
                <h2 class="mb-3" data-aos="fade-up" data-aos-delay="100">What IDSMS Provides</h2>
              </div>
            </div>
            <div class="row g-4">
              <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="0">
                <div class="service-card p-4 rounded-4 h-100 d-flex flex-column justify-content-between gap-5">
                  <div><span class="icon mb-4">
                    ...
                    <h3 class="fs-5 mb-3">Real-time Intrusion Detection</h3>
                    <p class="mb-4">Continuously analyze network traffic using signature and anomaly-based detection to surface suspicious activity in real time.</p>
              ...
              <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="200">
                <div class="service-card p-4 rounded-4 h-100 d-flex flex-column justify-content-between gap-5">
                  <div><span class="icon mb-4">
                    ...
                    <h3 class="fs-5 mb-3">Alerting &amp; Notifications</h3>
                    <p class="mb-4">Configurable alert rules, multi-channel notifications (email, SMS, Slack), and escalation workflows to ensure fast response.</p>
                  </div><a class="special-link d-inline-flex gap-2 align-items-center text-decoration-none" href="#"><span class="icons"><i class="icon-1 bi bi-arrow-right-short"></i><i class="icon-2 bi bi-arrow-right-short"> </i></span><span>Read more</span></a>
                </div>
              </div>
              <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="300">
                <div class="service-card p-4 rounded-4 h-100 d-flex flex-column justify-content-between gap-5">
                  <div><span class="icon mb-4">
                    ...
                    <h3 class="fs-5 mb-3">Comprehensive Logging</h3>
                    <p class="mb-4">Capture and retain enriched event logs and packet metadata for forensic investigations and compliance with secure storage.</p>
                  </div><a class="special-link d-inline-flex gap-2 align-items-center text-decoration-none" href="#"><span class="icons"><i class="icon-1 bi bi-arrow-right-short"></i><i class="icon-2 bi bi-arrow-right-short"> </i></span><span>Read more</span></a>
                </div>
              </div>
              <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="400">
                <div class="service-card p-4 rounded-4 h-100 d-flex flex-column justify-content-between gap-5">
                  <div><span class="icon mb-4">
                    ...
                    <h3 class="fs-5 mb-3">Dashboard &amp; Analytics</h3>
                    <p class="mb-4">Interactive dashboards with charts, top attacked hosts, timelines, and powerful filters for rapid triage and trend analysis.</p>
                  </div><a class="special-link d-inline-flex gap-2 align-items-center text-decoration-none" href="#"><span class="icons"><i class="icon-1 bi bi-arrow-right-short"></i><i class="icon-2 bi bi-arrow-right-short"> </i></span><span>Read more</span></a>
                </div>
              </div>
              <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="500">
                <div class="service-card p-4 rounded-4 h-100 d-flex flex-column justify-content-between gap-5">
                  <div><span class="icon mb-4">
                    ...
                    <h3 class="fs-5 mb-3">Rule Management &amp; Tuning</h3>
                    <p class="mb-4">Create, test, and tune detection rules and suppression policies to reduce false positives and improve detection accuracy.</p>
                  </div><a class="special-link d-inline-flex gap-2 align-items-center text-decoration-none" href="#"><span class="icons"><i class="icon-1 bi bi-arrow-right-short"></i><i class="icon-2 bi bi-arrow-right-short"> </i></span><span>Read more</span></a>
                </div>
              </div>
              <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="600">
                <div class="service-card p-4 rounded-4 h-100 d-flex flex-column justify-content-between gap-5">
                  <div><span class="icon mb-4">
                    ...
                    <h3 class="fs-5 mb-3">API &amp; Integrations</h3>
                    <p class="mb-4">REST ingestion and query APIs plus integrations for SIEM, ticketing systems, and threat intelligence feeds to fit existing workflows.</p>
                  </div><a class="special-link d-inline-flex gap-2 align-items-center text-decoration-none" href="#"><span class="icons"><i class="icon-1 bi bi-arrow-right-short"></i><i class="icon-2 bi bi-arrow-right-short"> </i></span><span>Read more</span></a>
                </div>
              </div>
            </div>
                    ...
                    <div class="authentication-inner" style="border-radius: 12px; box-shadow: 0 10px 40px rgba(0, 0, 0, 0.15);">
                      <div class="card" style="border: none; box-shadow: none;">
                        <div class="card-body" style="padding: 2.5rem;">
                          ...
                          <p class="mb-4 text-center" style="color: #999; font-size: 0.95rem;">LOGIN ACCOUNT</p>
                          <form id="formAuthentication" class="mb-3" action="{{ route('login.post') }}" method="POST">
                            @csrf
                            <div class="mb-3">
                              <label for="email" class="form-label" style="color: #333; font-weight: 600; font-size: 0.9rem;">Email</label>
                              <input
                                type="email"
                                class="form-control"
                                id="email"
                                ...
                                autofocus
                                required
                                style="border: 2px solid #e5e7eb; border-radius: 8px; padding: 0.75rem 1rem; transition: all 0.3s ease;"
                              />
                            </div>
                            <div class="mb-3 form-password-toggle">
                              <div class="d-flex justify-content-between align-items-center" style="margin-bottom: 0.75rem; flex-wrap: wrap; gap: 10px;">
                                <label class="form-label" for="password" style="color: #333; font-weight: 600; font-size: 0.9rem;">Password</label>
                              ...
                              <div class="input-group input-group-merge">
                                <input
                                  ...
                                  required
                                  style="border: 2px solid #e5e7eb; border-radius: 8px 0 0 8px; padding: 0.75rem 1rem; transition: all 0.3s ease;"
                                />
                                <span class="input-group-text cursor-pointer" style="border: 2px solid #e5e7eb; background-color: #f9fafb; border-radius: 0 8px 8px 0; color: #667eea; cursor: pointer;"><i class="bx bx-hide"></i></span>
                              </div>
                            </div>
                          
                            <div class="mb-3">
                              <button class="btn btn-primary d-grid w-100" type="submit" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border: none; border-radius: 8px; padding: 0.75rem 1.5rem; font-weight: 600; font-size: 1rem; transition: all 0.3s ease; box-shadow: 0 4px 15px rgba(102, 126, 234, 0.3);">Sign in</button>
                            </div>
                          </form>
    ...
    <script src="{{ asset('landing/assets/vendors/isotope/isotope.pkgd.min.js') }}"></script>
    <script src="{{ asset('landing/assets/vendors/glightbox/glightbox.min.js') }}"></script>
      ...
      document.addEventListener('DOMContentLoaded', function() {
        ...
        toggles.forEach((toggle) => {
          toggle.addEventListener('click', function(e) {
            ...
            console.log('Toggle clicked - Input type:', input?.type, 'Icon:', icon?.className);
            ...
            if (input && icon) {
              ...
              console.log('Error: Could not find input or icon');
            }
          });
        });
      });
